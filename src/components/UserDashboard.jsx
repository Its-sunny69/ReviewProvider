          ...
          <Modal isOpen={modalOpen} isClosed={closeModal}>
            ...
            <div className="w-full sm:grid sm:grid-cols-6">
              <div className="flex justify-center items-center sm:col-span-4">
                <Code
                  code={`<iframe src=${window.location.origin}/iframe/${state.data._id} width="500" height="500" style="border:none;" title="Dynamic Content"></iframe>`}
                  language="javascript"
                  copy={true}
                />
              </div>
              <div className="flex justify-center items-center col-span-2">
                {
                  <iframe
                    height={500}
                    width={200}
                    src={`http://localhost:5173/iframe/${state.data._id} `}
                    frameborder="0"
                  ></iframe>
                }
              </div>
